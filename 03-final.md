...
### 기타 특전
- 1등상 수상팀은 SK 텔레콤 Junior Talent 채용 지원시 혜택 제공

## 유의사항

### 본선 등록

- 등록 시 팀원 3인 모두가 자신의 주민등록증, 운전면허증, 여권 중 하나를 (실물 신분증의 형태로) 지참해야 합니다. 모바일 신분증이 아닌 실물 신분증을 지참해야 합니다.
  - 생년월일과 이름 외의 다른 정보는 테이프 등으로 마스킹 해도 됩니다.
  - 주민등록증, 운전면허증, 여권이 모두 없는 경우 주최측으로 사전에 문의 바랍니다.
- 대회장 입장을 위해서는 팀원 3인 모두가 동시에 등록해야 합니다.
  - 한 명 이상의 팀원이 부재중인 경우 입장이 불가능합니다.
- 대회 시작 시각 이후에는 입장이 불가능합니다.
  - 대회 시작 시각에 가까워질수록 등록이 지연될 수 있습니다. 오전 10시 20분 까지 도착하지 않으면 입장이 어려울 수 있으며, 등록이 지연되어 발생하는 불이익은 책임지지 않습니다.
