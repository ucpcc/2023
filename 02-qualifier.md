...
2023년 7월 1일 14시 부터 17시 까지 진행됩니다.
예선 대회에 앞서 6월 28일 12시 -- 7월 1일 0시에 예비소집이 진행됩니다.
...
- 본선 참가 팀 중 15% 이내에 대해 다음의 기준으로 추가 선발할 수 있습니다. 같은 추가 선발 기준을 적용 받는 팀들 중에서는 순위에 따라 선발합니다.
  - 순위에 따른 본선 진출자가 없는 학교의 학사과정 소속 3인으로 구성된 팀 (단, 3인은 모두 동일 학교 소속이어야 한다.)
  - 여성 참가자가 포함된 팀
  - 복수전공, 이중전공을 포함해 수학 및 컴퓨터 관련 전공자가 아닌 사람 2인 이상으로 구성된 팀
